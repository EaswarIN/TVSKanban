class ProdPlanHeadersController < ApplicationController
  ...
  private
    ...
    def prod_plan_header_params
      ...
      params.require(:trn_prod_plan_header).permit(:plant, :work_center, :sfg_uom, schedule: [:sfg_desc, :sfg_code, :trt_code, :day_req_qty_m2, :stock_qty, :sfg_plan_qty, :sfg_sequence, :bom_type, :schedule_no, :schedule_status, :safety_stock, :max_stock, :re_order_point, :action_status, :po_type])
